import pygame
from .game_object import GameManagerObject
from .lifebar import Lifebar
from ..settings import *


class Entity(GameManagerObject):    
    def __init__(
            self, 
            max_health: int = 100, 
        ...
        """Entity class. GameManagerObject with health and lifebar, can be hit if not invulnerable.
